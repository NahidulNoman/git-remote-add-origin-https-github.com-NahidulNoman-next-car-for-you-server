...
async function run() {
  try {
    ...
    const bookingsCollection = client.db("nextCarSell").collection("bookings");
    const usersCollection = client.db("nextCarSell").collection("users");
    const homesCollection = client.db("nextCarSell").collection("homes");
    const paymentsCollection = client.db("nextCarSell").collection("payments");
